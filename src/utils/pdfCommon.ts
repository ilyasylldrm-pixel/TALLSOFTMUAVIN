/**
 * Common formatting and DOM sanitization utilities for PDF generation.
 * Separated into pdfCommon.ts to break circular dependency cycles between
 * exportUtils, pdfService, and assetCustodyPdf.
 */
...
/**
 * Helper: converts OKLCH color components to sRGB [0..255]
 */
...
/**
 * Parses OKLCH color string into rgb/rgba
 */
...
/**
 * Replaces modern color functions in CSS string with resolved rgb/rgba
 */
...
export function sanitizeOklchForHtml2Canvas(clonedDoc: Document): void {
  try {
    ...
    console.warn("sanitizeOklchForHtml2Canvas warning:", err);
  }
}
