...
export const calculatePayrollRecordHelper = (
  ...
  // Emekli personel için SGDP (Sosyal Güvenlik Destek Primi) oranları uygulanır:
  // - İşçi SGDP: %7.5 (Normalde SGK %14)
  // - İşçi İşsizlik: %0 (Emekliler işsizlik sigortasına tabi değildir; Normalde %1)
  // - İşveren SGDP: %24.5 (%22.25 SGDP + %2.25 KVSK; Normalde %15.5)
  // - İşveren İşsizlik: %0 (Normalde %2)
