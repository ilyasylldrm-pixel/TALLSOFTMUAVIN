...
function generate100NewCustomerContacts(): Contact[] {
  ...
  const flagshipCompanies = [
    {
      name: "ASELSAN Elektronik Sanayi ve Ticaret A.Ş.",
      companyTitle: "ASELSAN Elektronik San. ve Tic. A.Ş.",
      taxNumber: "0910014073",
      taxOffice: "Ankara Kurumlar V.D.",
      city: "Ankara",
      district: "Yenimahalle",
      phone: "0312 592 10 00",
      email: "muhasebe@aselsan.com.tr",
    },
    {
      name: "TURKCELL İletişim Hizmetleri A.Ş.",
      companyTitle: "TURKCELL İletişim Hizmetleri A.Ş.",
      taxNumber: "8790018730",
      taxOffice: "Büyük Mükellefler V.D.",
      city: "İstanbul",
      district: "Maltepe",
      phone: "0212 313 10 00",
      email: "fatura@turkcell.com.tr",
    },
    {
      name: "TRENDYOL - DSM Grup Danışmanlık A.Ş.",
      companyTitle: "DSM Grup Danışmanlık İletişim ve Satış Tic. A.Ş.",
      taxNumber: "3130557663",
      taxOffice: "Büyük Mükellefler V.D.",
      city: "İstanbul",
      district: "Şişli",
      phone: "0212 331 02 00",
      email: "finans@trendyol.com",
    },
    {
      name: "MİGROS Ticaret A.Ş.",
      companyTitle: "MİGROS Ticaret A.Ş.",
      taxNumber: "6220529513",
      taxOffice: "Anadolu Kurumlar V.D.",
      city: "İstanbul",
      district: "Ataşehir",
      phone: "0216 574 00 00",
      email: "efatura@migros.com.tr",
    },
    {
      name: "MYSOFT Dijital Dönüşüm A.Ş.",
      companyTitle: "MYSOFT Dijital Dönüşüm ve Bilişim Hizmetleri A.Ş.",
      taxNumber: "6240683260",
      taxOffice: "Marmara Kurumlar V.D.",
      city: "İstanbul",
      district: "Ümraniye",
      phone: "0216 999 00 99",
      email: "destek@mysoft.com.tr",
    },
    {
      name: "Ahmet Yılmaz (Bireysel / e-Arşiv Müşterisi)",
    ...
    {
      name: "Ayşe Kaya (Nihai Tüketici / e-Arşiv)",
      companyTitle: "Ayşe Kaya",
  ...
  flagshipCompanies.forEach((fc, idx) => {
    const isEArsiv = fc.taxNumber.length === 11;
    contacts.push({
      id: `cnt_flagship_${idx + 1}`,
      accountCode: `120.${fc.taxNumber}`,
      name: fc.name,
      companyTitle: fc.companyTitle,
      contactType: "customer",
      taxOffice: fc.taxOffice,
      taxNumber: fc.taxNumber,
      phone: fc.phone,
      email: fc.email,
      city: fc.city,
      district: fc.district,
      address: `${fc.district} Merkez Mah. İş Kuleleri Kat:5 ${fc.city}`,
      balance: isEArsiv ? 3500 : 85000 + idx * 12500,
