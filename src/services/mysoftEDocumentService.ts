...
export async function checkRecipientTaxpayerStatus(
  ...
  const fallback: RecipientTaxpayerStatus = {
    ...
    title: known?.title || (isCorporate ? "GİB Kayıtlı e-Fatura Mükellefi" : "Bireysel Müşteri"),
    ...
    name: known?.name || (isCorporate ? "GİB Kayıtlı Mükellef" : "Bireysel Müşteri"),
    ...
    contactPerson: known?.contactPerson || (isCorporate ? "Finans & Muhasebe Sorumlusu" : "Müşteri Yetkilisi"),
  };
