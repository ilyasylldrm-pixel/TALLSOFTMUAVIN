...
import { AutoServiceRecord, AutoPartItem, AutoLaborItem, Contact, AutoServiceStatus } from "../../types";
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({ ...formData, status: e.target.value as AutoServiceStatus })}
                    className="w-full px-3 py-2 rounded-xl border border-purple-200 font-bold bg-white focus:ring-2 focus:ring-purple-500"
                  >
                    <option value="reception">Servis Kabul</option>
                    <option value="diagnosis">Teşhis / Ekspertiz</option>
                    <option value="quote_pending">Fiyat Onayı Bekliyor</option>
                    <option value="parts_pending">Parça Bekleniyor</option>
                    <option value="in_progress">Onarımda / Liftte</option>
                    <option value="testing">Test Sürüşü</option>
                    <option value="ready">Teslime Hazır</option>
