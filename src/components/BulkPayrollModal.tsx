...
export const BulkPayrollModal: React.FC<BulkPayrollModalProps> = ({
  ...
  const getEffectiveAdjustment = (emp: Employee): CustomPayrollAdjustment => {
    ...
    const isRetired = userManual.isRetired !== undefined
      ? userManual.isRetired
      : (existingCustom.isRetired !== undefined ? existingCustom.isRetired : Boolean(emp.isRetired));
    ...
    const besDeduction = userManual.besDeduction !== undefined
      ...
      : (existingCustom.besDeduction !== undefined
          ...
          : (integrateBes && emp.hasBes && !isRetired ? Math.round(baseGrossVal * 0.03) : 0));
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-xs font-bold text-slate-700 block mb-1">
                      BES (%3) Kesintisi:
                      {currentActiveData.employee.isRetired && (
                        <span className="ml-1 text-[10px] text-blue-700 font-semibold">(Emekli Muaf)</span>
                      )}
                    </label>
                    <input
                      type="number"
