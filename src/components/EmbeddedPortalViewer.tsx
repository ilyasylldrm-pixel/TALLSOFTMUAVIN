        ...
        {showCredentialsBar && (
          <div className="bg-slate-950/90 border border-slate-800/90 rounded-2xl p-3 flex flex-wrap items-center justify-between gap-3 text-xs">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Direct Autofill Action */}
              <button
                type="button"
                onClick={handleAutoFill}
                className="px-2.5 py-1 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-black text-[11px] rounded-lg shadow-sm flex items-center gap-1 cursor-pointer transition active:scale-95"
                title="Şifreleri bu sayfaya doğrudan aktar"
              >
