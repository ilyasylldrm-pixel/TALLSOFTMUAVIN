...
export const InvoiceTaxSettingsModal: React.FC<InvoiceTaxSettingsModalProps> = ({
  ...
  return (
    <DetailPageLayout
      ...
      onBack={onClose}
      statusBadge={
        <span className="bg-[#eaedff] text-[#005289] border border-[#dae2fd] text-xs font-bold px-3 py-1 rounded-xl font-mono tabular-nums">
          GİB VERGİ DÜZENLEMESİ
        </span>
      }
      headerIcon={<Sliders className="w-5 h-5 text-[#005289]" />}
      actions={
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={handleSave}
            className="flex items-center gap-2 px-5 py-2 rounded-xl bg-[#005289] hover:bg-[#00365d] text-white font-extrabold text-xs shadow-xs transition-all cursor-pointer active:scale-95"
          >
        ...
        <div className="flex items-center gap-1 border-b border-slate-200 bg-slate-100/70 p-1.5 shrink-0 overflow-x-auto">
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
              activeTab === "tevkifat"
                ? "bg-white text-[#005289] shadow-2xs border border-[#dae2fd]"
          ...
          >
            ...
            {withholdingEnabled && (
              <span className="w-2 h-2 rounded-full bg-[#005289] animate-pulse" />
            )}
          </button>
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
              activeTab === "ek_vergiler"
                ? "bg-white text-[#00629e] shadow-2xs border border-[#cfe5ff]"
                : "text-slate-600 hover:text-slate-900 hover:bg-slate-200/60"
            }`}
          >
            ...
            {additionalTaxes.length > 0 && (
              <span className="px-1.5 py-0.2 rounded-full bg-[#eaedff] text-[#005289] font-extrabold text-[10px] font-mono tabular-nums">
        ...
        <div className="p-4 space-y-4 overflow-y-auto custom-scrollbar flex-1 text-xs">
          ...
          {activeTab === "tevkifat" && (
            <div className="space-y-3.5 animate-fadeIn">
              <div className="flex items-center justify-between p-3 rounded-xl bg-[#eaedff]/80 border border-[#dae2fd]">
                <div className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    ...
                    className="w-4 h-4 rounded text-[#005289] focus:ring-[#0f6bae] cursor-pointer"
                  />
                  <label htmlFor="withholding-toggle" className="font-bold text-[#00365d] cursor-pointer text-xs">
                    Bu Kalemde KDV Tevkifatı Uygula
                  </label>
                </div>
                {withholdingEnabled && (
                  <span className="text-[11px] font-mono tabular-nums font-bold bg-[#005289] text-white px-2 py-0.5 rounded-full">
                ...
                <div className="space-y-3 bg-slate-50 p-3.5 rounded-xl border border-slate-200 animate-fadeIn">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {[
                        ...
                        <button
                          ...
                          className={`px-2.5 py-1.5 rounded-lg text-xs font-mono tabular-nums font-black transition-all cursor-pointer ${
                            numerator === itemRatio.num && denominator === 10
                              ? "bg-[#005289] text-white shadow-xs"
                              : "bg-white text-slate-700 border border-slate-200 hover:bg-[#eaedff] hover:text-[#005289]"
                          }`}
                        >
                          {itemRatio.label}
                        </button>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-slate-300 rounded-xl p-2 text-xs font-semibold text-slate-900 focus:ring-2 focus:ring-[#0f6bae]/20 focus:border-[#005289] cursor-pointer"
                    >
                  ...
                  {getWithholdingCodeInfo(withholdingCode)?.description && (
                    <div className="p-2 bg-[#f2f3ff] border border-[#dae2fd] rounded-lg text-[11px] text-[#00365d] flex items-start gap-1.5">
                      <HelpCircle className="w-3.5 h-3.5 text-[#005289] shrink-0 mt-0.5" />
          ...
          {activeTab === "ozel_matrah" && (
            <div className="space-y-3.5 animate-fadeIn">
              <div className="flex items-center justify-between p-3 rounded-xl bg-amber-50/80 border border-amber-200">
                ...
                {specialTaxBaseEnabled && (
                  <span className="text-[11px] font-mono tabular-nums font-bold bg-amber-600 text-white px-2 py-0.5 rounded-full">
                    KDV Kanunu Md. 23
                  </span>
                )}
              </div>
                ...
                <div className="space-y-3 bg-slate-50 p-3.5 rounded-xl border border-slate-200 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 bg-amber-50/50 p-3 rounded-xl border border-amber-200">
                    <div>
                      ...
                      <div className="p-2 bg-white border border-slate-200 rounded-lg font-mono tabular-nums font-bold text-slate-900 text-xs">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-amber-300 rounded-lg p-2 text-xs font-mono tabular-nums font-bold text-slate-900 focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="p-2 bg-amber-100/90 border border-amber-300 rounded-lg font-mono tabular-nums font-black text-amber-950 text-xs">
                  ...
                  <div className="p-2.5 bg-slate-100 rounded-xl border border-slate-200 text-[11px] text-slate-600">
                    ...
                    <p className="italic font-mono tabular-nums">
          ...
          {activeTab === "istisna" && (
            <div className="space-y-3.5 animate-fadeIn">
              <div className="flex items-center justify-between p-3 rounded-xl bg-emerald-50/80 border border-emerald-200">
                ...
                {exemptionEnabled && (
                  <span className="text-[11px] font-mono tabular-nums font-bold bg-emerald-600 text-white px-2 py-0.5 rounded-full">
                    KDV %0
                  </span>
                )}
              </div>
          ...
          {activeTab === "ek_vergiler" && (
            <div className="space-y-3.5 animate-fadeIn">
              {/* Kalem Bilgi Kartı */}
              <div className="p-3 bg-gradient-to-r from-[#eaedff] via-[#f2f3ff] to-[#cfe5ff] rounded-xl border border-[#dae2fd] shadow-2xs">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  <span className="text-[11px] font-black text-[#00365d] flex items-center gap-1.5">
                    <Sliders className="w-3.5 h-3.5 text-[#005289]" />
                    <span>Seçili Kalem:</span>
                  </span>
                  <span className="text-xs font-extrabold text-[#00365d] bg-white px-2.5 py-0.5 rounded-lg border border-[#dae2fd]">
                    {item.description || "Hizmet / Ürün Kalemi"}
                  </span>
                </div>
                <p className="text-[11px] text-slate-600 font-medium">
                  Miktar &amp; Fiyat: <span className="font-bold text-slate-800 font-mono tabular-nums">{item.quantity} {item.unit || "Adet"}</span> × <span className="font-bold text-slate-800 font-mono tabular-nums">{formatCurrency(item.unitPrice, currency)}</span> = <span className="font-extrabold text-[#005289] font-mono tabular-nums">{formatCurrency(item.quantity * item.unitPrice, currency)} Matrah</span>
                </p>
              </div>

              {/* Bilgi ve Hızlı Ekleme Paneli */}
              <div className="bg-[#eaedff]/60 border border-[#dae2fd] rounded-xl p-3 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-extrabold text-[#00365d] flex items-center gap-1.5">
                    <Tag className="w-3.5 h-3.5 text-[#005289]" />
                    <span>Hızlı Ek Vergi Ekle (Popüler GİB Oranları):</span>
                  </span>
                  <span className="text-[10px] text-[#005289] font-medium font-mono tabular-nums">31 GİB Ek Vergisi Tanımlı</span>
                </div>
                <div className="flex flex-wrap gap-1.5">
                  <button
                    type="button"
                    onClick={() => handleQuickAddTax("0074", 20, false, "percent")}
                    className="px-2 py-1 bg-white hover:bg-[#eaedff] text-[#005289] border border-[#dae2fd] rounded-lg text-[10px] font-mono tabular-nums font-bold transition-colors cursor-pointer shadow-2xs"
                  >
                    + ÖTV 4.Liste (%20)
                  </button>
                  <button
                    ...
                    className="px-2 py-1 bg-white hover:bg-amber-100 text-amber-900 border border-amber-200 rounded-lg text-[10px] font-mono tabular-nums font-bold transition-colors cursor-pointer shadow-2xs"
                  >
              ...
              <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-2xs space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-2.5 items-end">
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-slate-300 rounded-xl p-2 text-xs font-semibold text-slate-900 focus:ring-2 focus:ring-[#0f6bae]/20 focus:border-[#005289]"
                    >
                      ...
                      <button
                        ...
                        className={`flex-1 py-1.5 text-center text-[11px] font-bold rounded-lg transition-all cursor-pointer ${
                          selectedCalcType === "percent"
                            ? "bg-white text-[#005289] shadow-2xs border border-slate-200"
                  ...
                  <div className="sm:col-span-3">
                    ...
                    {selectedCalcType === "percent" ? (
                      <input
                        ...
                        className="w-full bg-white border border-slate-300 rounded-xl p-2 text-xs font-mono tabular-nums font-bold text-slate-900 focus:ring-2 focus:ring-[#0f6bae]/20 focus:border-[#005289]"
                      />
                    ) : (
                      <input
                        type="number"
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 pt-2 border-t border-slate-100">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 px-4 py-2 bg-[#005289] hover:bg-[#00365d] text-white text-xs font-bold rounded-xl shadow-xs transition-all cursor-pointer active:scale-95 shrink-0"
                  >
                        ...
                        <div
                          ...
                          className={`flex items-center justify-between p-2.5 rounded-xl border transition-all ${
                            isDeduct
                              ...
                              : "bg-[#f2f3ff]/70 border-[#dae2fd] text-[#00365d]"
                          }`}
                        >
                          <div className="flex items-center gap-2.5">
                            <span
                              className={`px-2 py-0.5 rounded-md font-mono tabular-nums font-extrabold text-[11px] ${
                                isDeduct ? "bg-amber-200 text-amber-900" : "bg-[#eaedff] text-[#005289] border border-[#dae2fd]"
                              }`}
                            >
                              {tax.code}
                            </span>
                            <div>
                              ...
                              <div className="text-[10px] text-slate-500 flex items-center gap-2 mt-0.5 font-mono tabular-nums">
                                <span>
                          ...
                          <div className="flex items-center gap-3">
                            {tax.calculationType === "percent" && (
                              <div className="flex items-center gap-1">
                                ...
                                <input
                                  ...
                                  className="w-16 bg-white border border-slate-300 rounded-lg px-2 py-1 text-xs font-mono tabular-nums font-bold text-right text-slate-900"
                                />
                              </div>
                            )}
                            ...
                            <div className="text-right">
                              <span
                                className={`font-mono tabular-nums font-black text-xs block ${
                                  isDeduct ? "text-amber-700" : "text-[#005289]"
                                }`}
                              >
                                {isDeduct ? "-" : "+"}
          ...
          <div className="bg-[#131b2e] text-white rounded-2xl p-3.5 space-y-2.5 shadow-lg border border-[#283044]">
            <div className="flex items-center justify-between border-b border-[#283044] pb-2">
              <span className="text-xs font-extrabold text-slate-300 flex items-center gap-1.5">
                <Calculator className="w-3.5 h-3.5 text-[#9dcaff]" />
                <span>Kalem Canlı Hesaplama Özeti</span>
              </span>
              <div className="flex items-center gap-1.5 font-mono tabular-nums">
                {additionalTaxes.length > 0 && (
                  <span className="text-[10px] bg-[#00365d] text-[#d9e8ff] px-2 py-0.5 rounded-full border border-[#0f6bae]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px]">
              <div>
                ...
                <span className="font-mono tabular-nums font-bold">{formatCurrency(computed.totalWithoutVat, currency)}</span>
              </div>

              <div>
                <span className="text-slate-400 block text-[10px]">KDV Matrahı:</span>
                <span className="font-mono tabular-nums font-bold text-amber-300">{formatCurrency(computed.effectiveTaxableAmount, currency)}</span>
              </div>

              <div>
                <span className="text-slate-400 block text-[10px]">Hesaplanan KDV:</span>
                <span className="font-mono tabular-nums font-bold text-[#9dcaff]">{formatCurrency(computed.calculatedVatAmount, currency)}</span>
              </div>
            ...
            {(computed.additionalTaxesAdditions > 0 || computed.additionalTaxesDeductions > 0) && (
              <div className="grid grid-cols-2 gap-2 text-[11px] pt-1.5 border-t border-[#283044]">
                <div>
                  <span className="text-[#9dcaff] block text-[10px]">İlave Ek Vergiler (ÖTV, ÖİV vb.):</span>
                  <span className="font-mono tabular-nums font-bold text-[#d9e8ff]">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-[#283044]">
        ...
        <div className="p-3 sm:p-4 bg-slate-50 border-t border-slate-200 shrink-0 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="px-5 py-2 rounded-xl text-xs font-black text-white bg-[#005289] hover:bg-[#00365d] shadow-sm transition-all cursor-pointer active:scale-95 flex items-center gap-1.5"
            >
              <Check className="w-4 h-4" />
              <span>Ayarları Uygula</span>
            </button>
