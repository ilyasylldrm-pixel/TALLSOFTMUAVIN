...
export const GibPortalModal: React.FC<GibPortalModalProps> = ({
  ...
  const setErrorMessage = (msg: string) => {
    ...
    if (msg) {
      triggerFormErrorNotification(msg, "GİB Portal Giriş Hatası");
    }
  };
      ...
      <div className="bg-white w-full max-w-4xl mx-auto rounded-3xl shadow-sm border border-slate-200 p-6 space-y-6">
          {!isLoggedIn ? (
            ...
            <div className="max-w-xl mx-auto space-y-6">
              ...
              {errorMessage && (
                <div className="haze-form-error-toast p-3.5 rounded-xl text-xs font-bold flex items-center justify-between gap-2 border border-[#fecdd3] text-[#7f1d1d]">
                  <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="text-[#991b1b] hover:text-[#7f1d1d] font-black cursor-pointer px-1 rounded hover:bg-[#b91c1c]/10"
                  >
                    ✕
                  </button>
                </div>
