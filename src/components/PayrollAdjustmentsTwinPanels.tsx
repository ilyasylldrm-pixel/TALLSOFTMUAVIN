        ...
        <div className="space-y-3">
                  ...
                  onChangeForm((prev) => ({
                    ...
                    besDeduction:
                      autoLegal.besDeduction > 0
                        ...
                        : (employee.hasBes && !employee.isRetired && !form.isRetired)
                        ? Math.round(
          ...
          <div className="bg-rose-50/50 rounded-2xl border border-rose-200/90 p-3 space-y-2.5 shadow-2xs">
            ...
            {selectedDeduction === "bes" && (
              <div className="space-y-2">
                {(employee.isRetired || form.isRetired) && (
                  <div className="p-2 bg-blue-50 border border-blue-200 rounded-xl text-[11px] text-blue-900 flex items-start gap-1.5">
                    <span className="shrink-0 font-bold">ℹ️</span>
                    <span>
                      Bu çalışan <strong>emekli (SGDP)</strong> statüsündedir. Emekli personeller zorunlu BES kesintisinden muaftır (isteğe bağlı hariç 0 ₺).
                    </span>
                  </div>
                )}
                <div className="space-y-1">
