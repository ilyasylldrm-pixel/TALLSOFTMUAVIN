      ...
      <div className="bg-white rounded-2xl p-5 border border-purple-100 shadow-sm space-y-4">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-purple-100/80 text-[#6938EF]">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full text-xs font-bold bg-purple-50 text-[#6938EF] border border-purple-200">
            ...
            <div className="flex items-center gap-1.5 ml-2">
              ...
              <button
                ...
                title="Bugüne Git"
                className="px-3 py-1.5 rounded-xl bg-purple-50 hover:bg-purple-100 text-[#6938EF] text-xs font-bold border border-purple-200 active:scale-95 transition-all cursor-pointer"
              >
                Bugün
              </button>
              <button
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#6938EF] text-white font-bold text-xs shadow-md hover:bg-[#5928DF] active:scale-95 transition-all cursor-pointer"
            >
